...
//Here i use extern keyword in Extesion_size to link externally in encode.c
extern uint Extension_size;
//Here we just define the integer to extension_value to good readability
typedef int Extension_value;
/* 
...
//Here we also define newname for structure EncodeInfo and creating the structur member
...
/* Encode size to lsb*/
Status encode_size_to_lsb(Extension_value value, unsigned char *temparr);
